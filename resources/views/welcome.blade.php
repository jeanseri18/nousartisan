    ...
    <div class="pt-90 pb-90 bg-dark shape-parent">
        ...
        <div class="container">
            <div class="row gy-70">
                ...
                <div class="col-lg-5">
                    <h1 class="text-white mb-45">Vous<span class="highlight"> avez des competences technique ?</span> </h1>
                    <p class="mb-45 font-size-18 fw-medium text-white pe-lg-30">Developper votre votre activités .Faites valoir vos competences et developper votre chiffre d'affaire sur Nousartisans</p><!-- Button--><a class="btn btn-accent-1" href="contact-01.html" target="_self">Inscrivez vous maintenant<svg class="ms-15 align-self-center" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 15">
        ...
        <div class="container">
            <div class="row mb-90">
                <div class="col-lg-4 offset-lg-4 text-center"><span class="badge bg-light text-dark mb-20" data-show="startbox">Services</span>
                    <h2 class="m-0" data-show="startbox" data-show-delay="100">Les services les plus utilisés</h2>
                </div>
            </div>
            <div class="row gy-30">
                <div class="col-12 col-md-6 col-lg-4" data-show="startbox">
                    <!-- Service case-->
                    <div class="service-case lift rounded-4 bg-white shadow overflow-hidden"><a class="service-case-image" href="service-single.html" data-img-height style="--img-height: 64%;"><img loading="lazy" src="assets/img/service-case-1-740x480.jpg" alt=""></a>
                        <div class="service-case-body position-relative">
                            <!-- Circle icon-->
                            <div class="circle-icon circle-icon-sm text-white bg-accent-1 position-absolute me-50 top-0 end-0 translate-middle-y"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="19" fill="none">
                                    <path fill="currentColor" fill-rule="evenodd" d="M20.493 18.382c.396-.396.618-.933.618-1.493V5.278A2.111 2.111 0 0 0 19 3.167H9.5L7.389 0H2.11A2.111 2.111 0 0 0 0 2.111V16.89A2.111 2.111 0 0 0 2.111 19H19c.56 0 1.097-.222 1.493-.618Zm-8.938-9.938a1 1 0 1 0-2 0v2.167H7.388a1 1 0 1 0 0 2h2.167v2.167a1 1 0 1 0 2 0V12.61h2.166a1 1 0 0 0 0-2h-2.166V8.444Z" clip-rule="evenodd" />
                                </svg></div>
                            <h4 class="service-case-title mb-15">Project Engineering</h4>
                            <p class="service-case-text font-size-15 mb-30">Beast whose. You&quot;ll may fruit don&quot;t deep abundantly own void.</p><a class="service-case-arrow stretched-link" href="service-single.html"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                ...
                <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="100">
                    <!-- Service case-->
                    <div class="service-case lift rounded-4 bg-white shadow overflow-hidden"><a class="service-case-image" href="service-single.html" data-img-height style="--img-height: 64%;"><img loading="lazy" src="assets/img/service-case-2-740x480.jpg" alt=""></a>
                        <div class="service-case-body position-relative">
                            <!-- Circle icon-->
                            <div class="circle-icon circle-icon-sm text-white bg-accent-1 position-absolute me-50 top-0 end-0 translate-middle-y"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" fill="none">
                                    <path fill="currentColor" d="M11 18.904h9ZM15.5 2.424a2.123 2.123 0 0 1 3.621 1.498 2.115 2.115 0 0 1-.621 1.499L6 17.905l-4 .999 1-3.995L15.5 2.424Z" />
                                    <path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.3" d="M11 18.904h9m-4.5-16.48a2.123 2.123 0 0 1 3.621 1.498 2.115 2.115 0 0 1-.621 1.499L6 17.905l-4 .999 1-3.995L15.5 2.424Z" />
                                </svg></div>
                            <h4 class="service-case-title mb-15">Architecture</h4>
                            <p class="service-case-text font-size-15 mb-30">Greater whose waters of, female you fill darkness.</p><a class="service-case-arrow stretched-link" href="service-single.html"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                    <path stroke="currentColor" stroke-width="1.7" d="M0 7h18m0 0-6.75-6M18 7l-6.75 6" />
                                </svg></a>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="200">
                    <!-- Service case-->
                    <div class="service-case lift rounded-4 bg-white shadow overflow-hidden"><a class="service-case-image" href="service-single.html" data-img-height style="--img-height: 64%;"><img loading="lazy" src="assets/img/service-case-3-740x480.jpg" alt=""></a>
                        <div class="service-case-body position-relative">
                            <!-- Circle icon-->
                            <div class="circle-icon circle-icon-sm text-white bg-accent-1 position-absolute me-50 top-0 end-0 translate-middle-y"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="21" fill="none">
                                    <path fill="currentColor" d="m11.625.5 3.36 6.665L22.5 8.24l-5.438 5.185 1.284 7.325-6.721-3.46-6.72 3.46 1.282-7.325L.75 8.24l7.515-1.075L11.625.5Z" />
                                </svg></div>
                            <h4 class="service-case-title mb-15">Lease Review</h4>
                            <p class="service-case-text font-size-15 mb-30">Won't had morning for, living and gathered was after over seas.</p><a class="service-case-arrow stretched-link" href="service-single.html"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                    <path stroke="currentColor" stroke-width="1.7" d="M0 7h18m0 0-6.75-6M18 7l-6.75 6" />
                                </svg></a>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="300">
                    <!-- Service case-->
                    <div class="service-case lift rounded-4 bg-white shadow overflow-hidden"><a class="service-case-image" href="service-single.html" data-img-height style="--img-height: 64%;"><img loading="lazy" src="assets/img/service-case-4-740x480.jpg" alt=""></a>
                        <div class="service-case-body position-relative">
                            <!-- Circle icon-->
                            <div class="circle-icon circle-icon-sm text-white bg-accent-1 position-absolute me-50 top-0 end-0 translate-middle-y"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="none">
                                    <path fill="currentColor" d="M13 2 2 7.5 13 13l11-5.5L13 2Z" />
                                    <path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.3" d="M2 18.5 13 24l11-5.5M2 13l11 5.5L24 13M13 2 2 7.5 13 13l11-5.5L13 2Z" />
                                </svg></div>
                            <h4 class="service-case-title mb-15">Construction</h4>
                            <p class="service-case-text font-size-15 mb-30">Lesser which creepeth had fruit air great be it him.</p><a class="service-case-arrow stretched-link" href="service-single.html"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                    <path stroke="currentColor" stroke-width="1.7" d="M0 7h18m0 0-6.75-6M18 7l-6.75 6" />
                                </svg></a>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="400">
                    <!-- Service case-->
                    <div class="service-case lift rounded-4 bg-white shadow overflow-hidden"><a class="service-case-image" href="service-single.html" data-img-height style="--img-height: 64%;"><img loading="lazy" src="assets/img/service-case-5-740x480.jpg" alt=""></a>
                        <div class="service-case-body position-relative">
                            <!-- Circle icon-->
                            <div class="circle-icon circle-icon-sm text-white bg-accent-1 position-absolute me-50 top-0 end-0 translate-middle-y"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" fill="none">
                                    <path fill="currentColor" fill-rule="evenodd" d="M12.5 0h-10A2.5 2.5 0 0 0 0 2.5v20A2.5 2.5 0 0 0 2.5 25h15a2.5 2.5 0 0 0 2.5-2.5v-15L12.5 0ZM5 7.75a1 1 0 1 0 0 2h2.5a1 1 0 1 0 0-2H5Zm0 5a1 1 0 1 0 0 2h10a1 1 0 1 0 0-2H5Zm0 5a1 1 0 1 0 0 2h10a1 1 0 1 0 0-2H5Z" clip-rule="evenodd" />
                                </svg></div>
                            <h4 class="service-case-title mb-15">Project Management</h4>
                            <p class="service-case-text font-size-15 mb-30">Moving won't him without doesn't winged lights fruit be, beast.</p><a class="service-case-arrow stretched-link" href="service-single.html"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                    <path stroke="currentColor" stroke-width="1.7" d="M0 7h18m0 0-6.75-6M18 7l-6.75 6" />
                                </svg></a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="500">
                    <!-- Service case-->
                    <div class="service-case lift rounded-4 bg-white shadow overflow-hidden"><a class="service-case-image" href="service-single.html" data-img-height style="--img-height: 64%;"><img loading="lazy" src="assets/img/service-case-6-740x480.jpg" alt=""></a>
                        <div class="service-case-body position-relative">
                            <!-- Circle icon-->
                            <div class="circle-icon circle-icon-sm text-white bg-accent-1 position-absolute me-50 top-0 end-0 translate-middle-y"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="23" fill="none">
                                    <path fill="currentColor" d="M10.002.75c-3.113 0-5.657 2.54-5.657 5.647s2.544 5.647 5.657 5.647c3.112 0 5.656-2.54 5.656-5.647S13.114.75 10.002.75ZM19.708 16.557a5.264 5.264 0 0 0-.568-1.036c-1.136-1.677-2.89-2.786-4.866-3.058-.246-.024-.518.025-.716.173a5.956 5.956 0 0 1-3.556 1.159 5.956 5.956 0 0 1-3.557-1.159.928.928 0 0 0-.716-.173 6.98 6.98 0 0 0-4.866 3.058c-.222.32-.42.69-.568 1.036-.074.148-.05.32.024.469.198.345.445.69.667.986.346.468.717.888 1.136 1.282.346.346.741.666 1.137.987A11.202 11.202 0 0 0 9.977 22.5c2.42 0 4.767-.765 6.718-2.22.395-.295.79-.64 1.136-.986.395-.394.79-.814 1.136-1.282.247-.32.47-.641.667-.986.124-.148.148-.321.074-.469Z" />
                                </svg></div>
                            <h4 class="service-case-title mb-15">Maintenance</h4>
                            <p class="service-case-text font-size-15 mb-30">Of sixth creeping whales morning deep have, reepeth moveth.</p><a class="service-case-arrow stretched-link" href="service-single.html"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                    <path stroke="currentColor" stroke-width="1.7" d="M0 7h18m0 0-6.75-6M18 7l-6.75 6" />
                                </svg></a>
                        </div>
                    </div>
                ...
                <div class="pt-120 pb-130 px-30 position-relative rounded-4 overflow-hidden z-index-1">
                    ...
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3 text-center">
                            <h2 class="mb-25 text-white" data-show="startbox">Avez vous une question?</h2>
                            <p class="mb-50 text-white" data-show="startbox" data-show-delay="100">Contactez nous pour tous vos besion</p>
                            <div data-show="startbox" data-show-delay="200">
                                <!-- Button--><a class="btn btn-accent-1" href="contact-01.html" target="_self">Contactez nous <svg class="ms-15 align-self-center" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 15">
                                        <path fill="currentColor" d="M15 11.23v2.259a1.501 1.501 0 0 1-1.026 1.432c-.199.067-.41.092-.619.073a14.944 14.944 0 0 1-6.508-2.31A14.692 14.692 0 0 1 2.32 8.166 14.877 14.877 0 0 1 .006 1.641 1.503 1.503 0 0 1 .9.13 1.51 1.51 0 0 1 1.507 0H3.77a1.51 1.51 0 0 1 1.508 1.295c.095.722.273 1.432.528 2.115a1.503 1.503 0 0 1-.34 1.588l-.957.956a12.055 12.055 0 0 0 4.525 4.516l.958-.956a1.51 1.51 0 0 1 1.591-.338 9.7 9.7 0 0 0 2.12.527 1.509 1.509 0 0 1 1.296 1.527Z" />
                                    </svg></a>
                            </div>
                        </div>
