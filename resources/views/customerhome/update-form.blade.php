    ...
    <div class="pt-120 pb-130">
        <div class="container">
            <div class="row gy-60 align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="gallery-wrapper pe-lg-70" data-show="startbox">
                        <a class="gallery-item rounded-4 overflow-hidden" href=""
                            style="--img-height: 110%;" data-img-height><img loading="lazy" src="{{ $myrequests->image }}"
                                alt=""></a>

                    </div><br><br><br>
                    <h3 class="mb-45" data-show="startbox">Serive{{ $myrequests->name }}</h3><br>
                ...
                @livewire('customerhome.updaterequest',['id'=>$myrequests->id])
