...
@section('content')
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide h-auto">
                    <div class="py-200 position-relative overflow-hidden h-100" data-name="Plomberie">
                        <div class="background">
                            <div class="background-image"><img loading="lazy" src="assets/img/home-3-slide-1-1920x1080.jpg"
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-lg-1">
                                    <h1 class="text-white mb-40">Trouvez le prestataire ideale à vos
                                        besions</h1><!-- Button-->
                                </div>
                            </div>
                        </div>
                ...
                <div class="swiper-slide h-auto">
                    <div class="py-200 position-relative overflow-hidden h-100" data-name="Chauffage">
                        <div class="background">
                            <div class="background-image"><img loading="lazy" src="assets/img/home-3-slide-2-1920x1080.jpg"
                                    data-swiper-parallax-x="20%" alt=""></div>
                            <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
                            <div class="background-color"
                                style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0) 150px);">
                ...
                <div class="swiper-slide h-auto">
                    <div class="py-200 position-relative overflow-hidden h-100" data-name="Menuiserie">
                        <div class="background">
                            <div class="background-image"><img loading="lazy" src="assets/img/home-3-slide-3-1920x1080.jpg"
                                    data-swiper-parallax-x="20%" alt=""></div>
                            <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
                            <div class="background-color"
                                style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0) 150px);">
                ...
                <div class="swiper-slide h-auto">
                    <div class="py-200 position-relative overflow-hidden h-100" data-name="Serrurerie">
                        <div class="background">
                            <div class="background-image"><img loading="lazy" src="assets/img/home-3-slide-4-1920x1080.jpg"
                                    data-swiper-parallax-x="20%" alt=""></div>
                            <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
                            <div class="background-color"
                                style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0) 150px);">
                ...
                <div class="swiper-slide h-auto">
                    <div class="py-200 position-relative overflow-hidden h-100" data-name="Menage">
                        <div class="background">
                            <div class="background-image"><img loading="lazy" src="assets/img/home-3-slide-4-1920x1080.jpg"
                                    data-swiper-parallax-x="20%" alt=""></div>
                            <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
                ...
                <div class="swiper-slide h-auto">
                    <div class="py-200 position-relative overflow-hidden h-100" data-name="Electricité">
                        <div class="background">
                            <div class="background-image"><img loading="lazy" src="assets/img/home-3-slide-4-1920x1080.jpg"
                                    data-swiper-parallax-x="20%" alt=""></div>
                            <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
                ...
                <div class="swiper-slide h-auto">
                    <div class="py-200 position-relative overflow-hidden h-100" data-name="Bricolage">
                        <div class="background">
                            <div class="background-image"><img loading="lazy"
                                    src="assets/img/home-3-slide-4-1920x1080.jpg" data-swiper-parallax-x="20%"
                                    alt=""></div>
                            <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
                            <div class="background-color"
                                style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0) 150px);">
    ...
    <div class="content-wrap  container">
        ...
        <center>
            <form class="form-group-overlay mx-lg-70 container col-md-8" method="GET"><input
                    class="form-control form-control-white form-control-style-3 shadow" type="text" name="search"
                    placeholder="Que cherche vous ?*" id="search" ><!-- Button--><button type="submit"
                    class="btn btn-accent-1 mt-6 me-6 no-transform"  href="#" target="_self">Recherhche</button>
        ...
        <div class="container">
            ...
            <div class="row gy-40">
                <div class="col-12 col-sm-6 col-lg-3" data-show="startbox">
                    <center>
                        <div class="h1 m-0 text-accent-2"><img src="assets/profil-de-lutilisateur18--67.png"
                                alt="" width="50"></div>
                        <div class="h6 mb-15">Artisans qualifiés</div>
                    </center>

                </div>
                <div class="col-12 col-sm-6 col-lg-3" data-show="startbox" data-show-delay="100">
                    <center>
                        <div class="h1 m-0 text-accent-2"><img src="assets/save-money--70.png" alt=""
                                width="50">
                        </div>
                        <div class="h6 mb-15">budget maitrisé</div>
                    </center>
                ...
                <div class="col-12 col-sm-6 col-lg-3" data-show="startbox" data-show-delay="200">
                    <center>
                        ...
                        <div class="h6 mb-15">Temps optimisé</div>
                    </center>

                </div>
                <div class="col-12 col-sm-6 col-lg-3" data-show="startbox" data-show-delay="300">
                    <center>
                        <div class="h1 m-0 text-accent-2"><img src="assets/24-hours--73.png" alt=""
                                width="50">
                        </div>
                        <div class="h6 mb-15">Intervention 24h/24 7j/7</div>
                    </center>
    ...
    <div class="pt-120 pb-130 bg-gray-light callToActionPrev">
        <div class="container">
            <div class="row mb-90">
                <div class="col-lg-4 offset-lg-4 text-center"><span class="badge bg-light text-dark mb-20"
                        data-show="startbox">Services</span>
                    <h5 class="m-0" data-show="startbox" data-show-delay="100">Trouvez le prestataire idéale à vos
                        besoins</h5>
                </div>
            </div>
            <div class="row gy-30">
    ...
    <div>
        <div class="container">
            <div class="row gy-50">
                <div class="col-lg-5">
                    <h3 class="mb-45" data-show="startbox">Vous<span class="highlight"> avez des competences technique
                            ?</span></h3>
                    <p class="mb-40" data-show="startbox" data-show-delay="100">Developper votre votre activités .Faites
                        valoir vos competences et developper votre chiffre d'affaire sur Nousartisans</p>
                    <div data-show="startbox" data-show-delay="200">
                        <!-- Button--><a class="btn btn-accent-1 btn-link btn-clean" href="#" target="_self">En
                            savoir plus</a>
                    </div>
                </div>
            ...
            <div class="card card-blog  col-md-4 " style="background-color: #d5d5d5">
                <div class="user_info mb10 container "><br>
                    <img src="https://www.nousartisans.com/theme/assets/img/default-avatar.png" class="rounded-circle"
                        width="50"><span class="name" style="font-weight: bold;"> Roger</span><br><br>

                    <span class="title fw5" style="font-weight: bold;">Pose chauffage</span><br>
                    <p class="mb20 fz09">Madame, Monsieur
                        Je souhaiterais installer un radiateur .
                        je dispose du matériel (système complet du radiateur) .
                        Le nombre de radiateurs à installer est de 1.
                        Pour votre information l’ancien système doit être retiré par vos soins.
                        Bien à vous.
                    </p>
                    <div class=" flex-col flex jc-end">
                        <span class="price  " style="font-weight: bold;color:#F01F4B">10 heures pour 10 € / heure</span>
                        <p class="flex ai-center jc-start mb5">
                            <span class="icon mr10 fz15"></span>20/06/2022 à 15:38<br>
                            <span class="icon mr10 fz15"></span>77500
                        </p>
                    </div>
                </div>
        </a>
    ...
    <div class="bg-linear-gradient pt-120 pb-130">
        <div class="container">
            <div class="justify-content-center d-flex align-items-center" data-show="startbox">
                <h2 class="m-0">Missions fraichement déposées</h2>
                <div class="d-inline-flex flex-column ms-20"><svg class="d-block" xmlns="http://www.w3.org/2000/svg" width="84" height="15" fill="none">
                    ...
                    </svg><span class="fw-medium font-size-13">chez nous</span></div>
            </div><!-- Slider-->
                        ...
                        <div class="swiper-slide h-auto">
                            ...
                            <div class="feedback bg-white rounded-4 h-100 shadow">
                                ...
                                <div class="feedback-header d-flex align-items-center mb-35">
                                    <div class="flex-shrink-0"><img class="rounded-circle" loading="lazy" src="https://www.nousartisans.com/theme/assets/img/default-avatar.png" alt="" height="64" width="64"></div>
                                    <div class="flex-grow-1 ms-20">
                                        <h6 class="feedback-author mb-5">{{$servicerequest->name}}</h6>
                                        <p class="feedback-position text-gray-dark font-size-14 m-0">{{$servicerequest->titre}}</p>
                                    </div>
                                </div>
                                <p class="feedback-text fw-medium text-dark m-0">“{{$servicerequest->task_description}}”</p>
                            </div>
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="pt-120 pb-130 px-30 position-relative rounded-4 overflow-hidden z-index-1">
                    ...
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3 text-center">
                            ...
                            <p class="mb-50 text-white" data-show="startbox" data-show-delay="100">Contactez nous pour
                                tous vos besion</p>
                            <div data-show="startbox" data-show-delay="200">
                                <!-- Button--><a class="btn btn-accent-1" href="contact-01.html" target="_self">Contactez
                                    nous <svg class="ms-15 align-self-center" xmlns="http://www.w3.org/2000/svg"
