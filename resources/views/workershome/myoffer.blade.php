...
@section('content')
    <div style="margin: 40px">
        <br>
        <a href="" class="btn btn-accent-2" style="background-color:blanchedalmond;color:black;">Toutes les
            offres</a>
        <a href="" class="btn btn-accent-2" style="background-color:#f5f5f5;color:black;">Offres en cours</a>
        <a href="" class="btn btn-accent-2" type="button" style="background-color:#f5f5f5;color:black;">Offres
            finalisées</a>
        <br><br>
                    ...
                    <div class="row" style="font-size: 14px">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="" class="btn btn-accent-1"
                                style="height: 50px;width:170px;font-size: 14px">Supprimer</a>
