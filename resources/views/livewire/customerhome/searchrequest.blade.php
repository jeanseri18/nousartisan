...
<div  class="form-group-overlay mx-lg-70 container col-md-8"><input
        class="form-control form-control-white form-control-style-3 shadow"
       wire:model="search" type="search" ><!-- Button-->
       <button
        class="btn btn-accent-1 mt-6 me-6 no-transform"  >Recherhche</button>
