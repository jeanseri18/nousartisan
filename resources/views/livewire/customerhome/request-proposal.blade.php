                ...
                <div class="" style="font-size: 12px"><br>
                    <div class="row">
                        <div class="col-md-3"><center> <img
                                ...
                                <strong>{{$proposal->name}}</strong></center>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{url('customer-home/myrequestsupdate',['id'=>$proposal->service_request_id,'worker'=>$proposal->id_worker,'statut'=>'1','price'=>$proposal->price_of_proposal])}}" class="btn btn-accent-2"
                                style="font-size: 12px">Accepter</a>
                        </div>
                    </div><br>
